...
<%@ page import="CRUD.Search_Contact" %>
...
<div class="container-fluid">
    <div class="row">
        <div class="center">
            ...
            <form action="add_contact.jsp">

                <input type="submit" value="afisare toate contactele" class="margin-top">
            </form>
            ...
            <form action="controller/add_controller.jsp">
                ...
                Numar :<input type="text" name="adresa3" class="width"><br>

                <input type="submit" value="Adauga" class="margin-top">
            ...
            <%
                ...
                String cautare_contact = request.getParameter("cautare_contact");


                Search_Contact s = new Search_Contact();
                List<User_Bean> list = s.searchContact(cautare_contact);
